...
public class AppInfoTest {
  private final String LABEL1 = "label1", LABEL2 = "label2";
  private final String NAME1 = "name.1", NAME2 = "name.2";
  private final AppInfo APP1 = new AppInfo(LABEL1, NAME1);
  private final AppInfo APP2 = new AppInfo(LABEL2, NAME2);
  private final AppInfo NULL1 = new AppInfo(null, NAME1);
  private final AppInfo NULL2 = new AppInfo(null, NAME2);
