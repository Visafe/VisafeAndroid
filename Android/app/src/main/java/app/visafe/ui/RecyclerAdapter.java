...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private final class Transaction {
    ...
    Transaction(@NonNull app.visafe.net.doh.Transaction transaction) {
      ...
      if (transaction.status == app.visafe.net.doh.Transaction.Status.COMPLETE) {
        ...
        if (transaction.status == app.visafe.net.doh.Transaction.Status.CANCELED) {
          flag = "\u274c";  // "X" mark
        } else {
          flag = "\u26a0";  // Warning sign
        }
   ...
   */
  public void reset(Queue<app.visafe.net.doh.Transaction> transactions) {
    this.transactions.clear();
    if (transactions != null) {
      for (app.visafe.net.doh.Transaction t : transactions) {
   ...
   */
  public void add(app.visafe.net.doh.Transaction transaction) {
