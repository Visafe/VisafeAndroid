...
import app.visafe.net.go.GoVpnAdapter;
...
public class ViSafeVpnService extends VpnService implements NetworkListener,
  ...
  private static final String LOG_TAG = "visafeVpnService";
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    synchronized (vpnController) {
      ...
      networkManager = new NetworkManager(ViSafeVpnService.this, ViSafeVpnService.this);
      ...
      builder.setContentTitle(getResources().getText(R.string.notification_title))
              .setSmallIcon(R.drawable.visafe_noti)
              .setSubText("- Internet an toàn")
  ...
  public void onCreate() {
    ...
    vpnController.setViSafeVpnService(this);
...
//        notificationManager.cancelAll();
  ...
  public void onDestroy() {
    synchronized (vpnController) {
      ...
      vpnController.setViSafeVpnService(null);
  ...
  public void recordTransaction(Transaction transaction) {
    ...
    LocalBroadcastManager.getInstance(ViSafeVpnService.this).sendBroadcast(intent);
