...
import com.vn.visafe_android.ui.adapter.OnClickWifi
import com.vn.visafe_android.ui.adapter.ProtectDeviceAdapter
import com.vn.visafe_android.ui.adapter.ProtectWifiAdapter
...
//                showDialogEdit(data, position)
    ...
    private fun handleProtected(isProtected: Boolean) {
        if (isProtected) {
            ...
            binding.ivWifi.background = ContextCompat.getDrawable(this, R.drawable.bg_stroke_color_green_circle)
            binding.tvTitle.text = HtmlCompat.fromHtml(getString(R.string.protected_wifi), HtmlCompat.FROM_HTML_MODE_LEGACY)
        } else {
            ...
            binding.ivWifi.background = ContextCompat.getDrawable(this, R.drawable.bg_stroke_color_red_circle)
            binding.tvTitle.text = HtmlCompat.fromHtml(getString(R.string.no_protected_wifi), HtmlCompat.FROM_HTML_MODE_LEGACY)
        }
    }
