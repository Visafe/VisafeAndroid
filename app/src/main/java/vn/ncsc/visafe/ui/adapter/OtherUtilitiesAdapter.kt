...
class OtherUtilitiesAdapter(
    private var listData: MutableList<OtherUtilitiesModel>,
    private var onItemClick: ((OtherUtilitiesModel, Int) -> Unit)
) : RecyclerView.Adapter<OtherUtilitiesAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OtherUtilitiesAdapter.ViewHolder {
        val binding =
