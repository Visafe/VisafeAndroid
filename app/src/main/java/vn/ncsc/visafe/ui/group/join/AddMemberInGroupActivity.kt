...
class AddMemberInGroupActivity : BaseActivity() {
    companion object {
        const val SCAN_CODE = "SCAN_CODE"
        const val NEW_MEMBER = "NEW_MEMBER"
    }

    private lateinit var binding: ActivityAddMemberInGroupBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddMemberInGroupBinding.inflate(layoutInflater)
    ...
    private fun enableButton() {
        ...
        if (name.isNotBlank()) {
            with(binding.tvComplete) {
                ...
                setTextColor(ContextCompat.getColor(this@AddMemberInGroupActivity, R.color.white))
                isEnabled = true
            }
        } else {
            with(binding.tvComplete) {
