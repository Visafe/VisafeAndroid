...
public class ViewFinderCustom extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.color_FFB31F);
    private final int mDefaultMaskColor = getResources().getColor(R.color.color_80_111111);
    private final int mDefaultBorderColor = getResources().getColor(R.color.color_FFB31F);
    ...
    public synchronized void updateFramingRect() {
        ...
        height = getWidth() - (int) getResources().getDimension(R.dimen._24sdp) * 2;
        width = height;

        int leftOffset = (viewResolution.x - width) / 2;
        int topOffset = (int) getResources().getDimension(R.dimen._56sdp);
    ...
    private void drawTradeMark(Canvas canvas) {
        ...
        float tradeMarkTop;
        if (framingRect != null) {
            tradeMarkTop = framingRect.bottom + mTextPaint.getTextSize() + 10;
        } else {
            tradeMarkTop = 10;
        }
        canvas.save();
